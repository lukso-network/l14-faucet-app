## LUKSO L14 Network faucet

### Building from source

1. Clone repository
  ```
  git clone https://github.com/lukso-network/lukso-faucet
  ```
...
5. Run faucet with `npm start`. LUKSO Network faucet will be launched at `http://localhost:5000`
...
```
{
  ...
  "Ethereum": {
    ...
    "prod": {
      "rpc": "JSON RPC endpoint. For example, http://rpc.l14.lukso.network",
